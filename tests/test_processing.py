...
def test_filter_by_state_like_executed(
    list_of_dict_input: list[dict], list_of_dict_output_executed: list[dict]
) -> None:
    assert processing.filter_by_state(list_of_dict_input, state="EXECUTED") == list_of_dict_output_executed


def test_filter_by_state_like_canceled(
    list_of_dict_input: list[dict], list_of_dict_output_canceled: list[dict]
) -> None:
